...
public class Pipe
{
    ...
    private readonly Rectangle topPipe;
    ...
    public bool CheckCollision(Bird bird)
    {
        ...
        Rect topBounds = new Rect(Canvas.GetLeft(topPipe), Canvas.GetTop(topPipe), topPipe.Width, topPipe.Height);
        Rect bottomBounds = new Rect(Canvas.GetLeft(bottomPipe), Canvas.GetTop(bottomPipe), bottomPipe.Width,
            bottomPipe.Height);
